...
public class SeasonGUI extends JFrame {
	...
	public SeasonGUI() {
		...
		lblNewLabel.setIcon(new ImageIcon(SeasonGUI.class.getResource("/images/logouttt.png")));
		...
		seasonpanel.setBackground(ClickedColor);
		...
		lblNewLabel_1.setIcon(new ImageIcon(SeasonGUI.class.getResource("/images/playerdefaultphoto.png")));
		...
		lblNewLabel_1_1.setIcon(new ImageIcon(SeasonGUI.class.getResource("/images/basketball-ball.png")));
		...
		lblNewLabel_1_2.setIcon(new ImageIcon(SeasonGUI.class.getResource("/images/basketball (1).png")));
		...
		lblNewLabel_1_3.setIcon(new ImageIcon(SeasonGUI.class.getResource("/images/season.png")));
